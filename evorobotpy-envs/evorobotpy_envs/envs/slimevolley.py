...
class SlimeVolleyEnv(gym.Env):
  ...
  def getObs(self):
    ...
    return np.concatenate((obs, otherObs))#obs
  ...
  #def step(self, action, otherAction=None):
    ...
    obs = self.getObs() # Contains both left and right agent's observations
    ...
    if self.survival_bonus:
      return obs, reward+0.01, done, False, info
...
register(
    id='SlimeVolley-v0',
    entry_point='slimevolley:SlimeVolleyEnv'
)

register(
    id='SlimeVolleyPixel-v0',
    entry_point='slimevolley:SlimeVolleyPixelEnv'
)

register(
    id='SlimeVolleyNoFrameskip-v0',
    entry_point='slimevolley:SlimeVolleyAtariEnv'
)

register(
    id='SlimeVolleySurvivalNoFrameskip-v0',
    entry_point='slimevolley:SlimeVolleySurvivalAtariEnv'
)
