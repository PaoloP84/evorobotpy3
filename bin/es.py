...
def main(argv):
    ...
    availableAlgos = ('OpenAI-ES', 'SSS', 'CMA-ES', 'xNES', 'sNES', 'GA', 'generational', 'hillclimber', 'evostick', 'SSSHC', 'OpenAI-ES_pop', 'PSO', 'DE', 'JADE', 'generalist', 'coevo2', 'coevo', 'archivestar1', 'coevoarch', 'coevosinglepop', 'archivestar1singlepop', 'coevoarchsinglepop')   # check whether the user specified a valid algorithm
